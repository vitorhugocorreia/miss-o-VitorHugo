...
function mostraAlternativas () { 
    for (const alternativa of perguntaAtual.alternativas) { 
        ...
        botaoAlternativa.textContent alternativa.texto botaoAlternativa.addEventListener("click", () => respostaselecionada (alternativa)); caixaAlternativas.appendChild(botaoAlternativa); function respostaSelecionada (opcaoSelecionada) { const afirmacao opcaoSelecionada.afirmacao; historiaFinal + afirmacao + ""; atual++ mostra Pergunta(); function mostraResultado () { caixaPerguntas.textContent "Resumindo..."; textoResultado.textContent historiaFinal; caixaAlternativas.textContent = ""; mostraPergunta();